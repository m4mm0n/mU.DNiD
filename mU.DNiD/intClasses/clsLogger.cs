    ...
    public class Logger : IDisposable
    {
        ...
        public Logger(LoggerType loggingType, string loggerOwner = null, bool isVerbose = false)
        {
            ...
            if ((loggingType == LoggerType.File) | (loggingType == LoggerType.Console_File))
            {
                ...
                var logHeader = @"  ____     _   _                ____    " + Environment.NewLine +
                                @" |  _ \   | \ | |       ___    |  _ \   " + Environment.NewLine +
                                @"/| | | | <|  \| |>     |_ _|  /| | | |  " + Environment.NewLine +
                                @"U| |_| |\U| |\  |u      | |   U| |_| |\ " + Environment.NewLine +
                                @" |____/ u |_| \_|     U/| |\u  |____/ u " + Environment.NewLine +
                                @"  |||_    ||   \\,-.-,_|___|_,-.|||_    " + Environment.NewLine +
                                @" (__)_)   (_ )  (_/ \_)-' '-(_/(__)_)   " + Environment.NewLine +
                                Environment.NewLine;
